...
export default function KelolaSiswa() {
    ...
    const statusRowFilterTemplate = (options: any) => {
        return (
            <Dropdown value={options.value} options={listJenisKelamin} onChange={(e) => options.filterApplyCallback(e.value)} placeholder="Select One" className="p-column-filter" showClear style={{ minWidth: '12rem' }} />
        );
    };
        ...
        <>
            <div className="card bg-white shadow-md p-5 border-t-4 border-t-blue-400 rounded-md">
                <div className="flex justify-between mb-4 items-center">
                    ...
                    <div className="p-inputgroup w-1/4">
                        <span className="p-inputgroup-addon">
                            <HiSearch />
                        </span>
                        <input type="text" placeholder='Cari ...' className='border px-3 py-2 w-full focus:outline-none' />
                    </div>
                </div>
                ...
                >
                    ...
                    <Column field="jenisKelamin" header="Jenis Kelamin" sortable
